	...
	<div id="container">
		...
		<div id="mainContent">
			...
			<ul>
				...
				<li>Jenis : <?= $b['jenis']; ?></li>
				<li>Nama : <?= $b['nama']; ?></li>
				<li>Jumlah : <?= $b['jumlah']; ?></li>
				<li>Penempatan : <?= $b['penempatan']; ?></li>
				<li><a href="tubah.php?id=<?= $b['id']; ?>">Ubah</a> | <a href="hapus.php?id=<?= $b['id']; ?>" onclick="return confirm('apakah anda yakin?');">Hapus</a></li>
				<li><a href="tlihat.php">Kembali ke Daftar Barang</a></li>
			</ul>
			<!-- end #mainContent -->
		</div>
